            ...
            <div style={{ maxHeight: 300, overflowY: 'auto' }}>
              {filteredTemplates.map((t) => (
                <div key={t.id} style={{ borderBottom: '1px solid #ddd', padding: 10 }}>
                  ...
                  <button onClick={() => applyTemplate(t)} style={{ marginTop: 5, marginRight: 10 }}>Use</button>
                  <button onClick={() => deleteTemplate(t.id)} style={{ marginTop: 5, color: 'red' }}>Delete</button>
                </div>
              ))}
            </div>
